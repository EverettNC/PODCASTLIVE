...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CBpka4lV.mjs");
...
var manifest = {
	"80d3a99c785681c8a6c4363243dccb28e38b13db934559e0c71c4e230664cceb": {
		functionName: "getAiStatus_createServerFn_handler",
		importer: () => import("./talk-DBZHSZeX.mjs")
	},
	"f835605c792a674fc03c2f03ff1ce7361012637a70c5e588938ef2c4ee5959ef": {
		functionName: "askHost_createServerFn_handler",
		importer: () => import("./talk-DBZHSZeX.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DksOEAKk.mjs").then((n) => n.t),
